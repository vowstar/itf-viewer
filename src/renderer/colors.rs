...
impl ColorScheme {
    ...
    fn get_dielectric_color(&self, layer_name: &str) -> Color32 {
        ...
        } else if name_lower.contains("pmd")
            || name_lower.contains("imd")
            || name_lower.contains("ild")
        {
...
mod tests {
    ...
    fn test_dielectric_colors() {
        ...
        let substrate =
            Layer::Dielectric(DielectricLayer::new("substrate".to_string(), 10.0, 11.9));
