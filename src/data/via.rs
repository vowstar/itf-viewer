...
impl ViaStack {
    ...
    pub fn get_connection_path(&self, from_layer: &str, to_layer: &str) -> Option<Vec<&ViaConnection>> {
        ...
        let mut parent: std::collections::HashMap<String, (&ViaConnection, String)> = std::collections::HashMap::new();
